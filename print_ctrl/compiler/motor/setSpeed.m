...
% 
% Usage:
%   printerAction = setSpeed(CFG.VXM_SPOTSIZE, 400); % Set the sped of motor 1 to 400 steps/s
%   printerAction = setSpeed([CFG.VXM_SPOTSIZE, CFG.VXM_ROLLER, CFG.VXM_XAXIS], 700); % Set the speed of motors 1-3 to 700 steps/s
% 
